...
public class RoutineSenseDataService implements DataService {
  ...
  /**
   * Retrieves event data via routinesense/read TODO make the server do that
   * @param date
		...
		requestBuilder.sendRequest(postParams, new RequestCallback() {
			...
			public void onResponseReceived(Request request, Response response) {          
				try {
					...
					List<EventInfo> result = AwDataTranslators.translateEventReadQueryJSONToEventInfoList(responseText);	//FIXME
